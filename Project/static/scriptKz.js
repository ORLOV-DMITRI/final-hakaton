import WeatherCity from "./jsKz/createCityKz.js";
import CreateTips from "./jsKz/createTipsKz.js";
...
function LoadSaveCity(x) {
  return fetch(`http://127.0.0.1:3000/api/cities/kz/${x}`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json;charset=utf-8",
    },
